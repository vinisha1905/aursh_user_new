...
part of 'consultation_create_order_model.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ConsultationCreateOrderModel _$ConsultationCreateOrderModelFromJson(
    ...
    ConsultationCreateOrderModel(
      ...
      ConsultationNoteModel.fromJson(json['notes'] as Map<String, dynamic>),
...
Map<String, dynamic> _$ConsultationCreateOrderModelToJson(
        ConsultationCreateOrderModel instance) =>
    <String, dynamic>{
